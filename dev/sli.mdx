...
- **Use case**: FlowOS dashboards fed from automations; Thinki.sh community stats.
- **Implementation**: event timestamp vs ingest timestamp; alert if > threshold.

## 4. Business Outcomes
- **Definition**: completion rate of key workflows (FlowOS ritual, AI agent task, Thinki.sh challenge).
